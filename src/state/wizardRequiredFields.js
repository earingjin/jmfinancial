...
export function computeWizardRequiredFields(formData) {
  ...
  const incomeRequiredFields = [
    ...
    ['income.severance.lumpsum', '퇴직금 일시금 수령액', getIn(formData, 'income.severance.type') === 'lumpsum'],
    ['income.severance.lumpsumAge', '퇴직금 일시금 수령 나이', getIn(formData, 'income.severance.type') === 'lumpsum'],
    ...
    ['spouse.severance.lumpsum', '배우자 퇴직금 일시금 수령액', hasSpouse && getIn(formData, 'spouse.severance.type') === 'lumpsum'],
    ['spouse.severance.lumpsumAge', '배우자 퇴직금 일시금 수령 나이', hasSpouse && getIn(formData, 'spouse.severance.type') === 'lumpsum'],
