...
export default function Report({ result, onRestart, onBack, onHome, clientName }) {
  const {
    generatedAt, indicators, aggregates, simulation, peerComparison, familyAges,
  ...
  const totalPages = 8 + Number(hasComposition) + Number(hasFutureFinance)
