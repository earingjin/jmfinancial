...
export const GRADE_BANDS = [
  ...
  { letter: 'C', label: '개선 필요', min: 60, max: 69, width: 10, color: '#D9CBA0', textColor: '#5B4E33', rangeLabel: '60~69', desc: '여러 지표가 권장기준을 못 미쳐 구조적인 개선이 필요함' },
  { letter: 'B', label: '양호', min: 70, max: 79, width: 10, color: 'var(--gold)', rangeLabel: '70~79', desc: '권장기준을 대체로 충족하되 일부 지표에서 개선 여지가 있음' },
  { letter: 'A', label: '건강', min: 80, max: 89, width: 10, color: '#E3A23C', rangeLabel: '80~89', desc: '대부분의 지표가 권장기준을 충족하여 재무구조가 안정적' },
  { letter: 'S', label: '매우 건강', min: 90, max: 100, width: 11, color: '#C9791F', rangeLabel: '90~100', desc: '9개 지표 전반이 권장 기준을 충분히 상회하는 이상적인 재무상태' },
];
