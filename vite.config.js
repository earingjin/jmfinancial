...
function localApiMiddleware() {
  return {
    ...
    configureServer(server) {
      ...
      registerPostRoute('/api/calculate', '/api/calculate.js');
      registerPostRoute('/api/reset-account', '/api/reset-account.js');
    },
  };
}
